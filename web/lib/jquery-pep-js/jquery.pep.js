              ...
              this.options.start.call(this, this.startEvent, this);
                ...
                if(this.dragIconMove === true){
                    ...
                    if($dragIcon.hasClass('nw')){
                        this.doMoveTo(dx, dy);
                        $pep.css({
                            'width': Math.max(this.options.minSize.w, this.dragPosix.x - hash.curX  + this.dragPosix.w),
                            'height': Math.max(this.options.minSize.h, this.dragPosix.y - hash.curY + this.dragPosix.h)
                        });
